...
const BLOG = {
  ...
  NOTION_PAGE_ID:process.env.NOTION_PAGE_ID || 'd070d714c3c24bb2a78bcb66b7119015',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '借力好风', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.jielihaofeng.online', // 网站地址
